...
const FirebasePermissionErrorModal: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 flex items-center justify-center p-4 font-sans">
      <div className="max-w-3xl w-full bg-gray-800 rounded-xl shadow-2xl p-6 sm:p-8 space-y-6 border border-red-500/30">
        ...
        <div className="space-y-4 text-gray-300">
            ...
            <ol className="list-decimal list-inside space-y-2 pl-4">
                ...
                <li>Select your project (<code className="bg-gray-700 p-1 rounded text-sm">multi-e4d82</code>).</li>
        ...
        <div className="relative bg-gray-900 rounded-lg p-4 font-mono text-sm">
            <button 
                onClick={handleCopy}
                className="absolute top-2 right-2 bg-gray-700 hover:bg-gray-600 text-gray-300 text-xs font-semibold py-1 px-2 rounded transition-colors"
            >
                {copied ? 'Copied!' : 'Copy'}
            </button>
        ...
        <div className="bg-yellow-900/50 border border-yellow-700 text-yellow-300 p-4 rounded-lg text-sm">
